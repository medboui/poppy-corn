...
class SeriesListThumbs extends StatelessWidget {
  const SeriesListThumbs({super.key, required this.category_id});
                                ...
                                Expanded(
                                  child: SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        Navigator.pushNamed(
                                            context, '/$screenSeriesDetails',
                                            arguments: model[index].seriesId!);
                                      },
                                      style: ButtonStyle(
